...
def parse_xml(file_path):
    ...
    for customer in root.findall('ns:customer', namespace):
        customer_data = {
            ...
            'customer_relation': customer.find('ns:customer_relation', namespace).text if customer.find('ns:customer_relation', namespace) is not None and customer.find('ns:customer_relation', namespace).text else 'RSCBEXTR',
            ...
            'contract': {
                ...
                'agent_number': customer.find('ns:contract/ns:agent_number', namespace).text if customer.find('ns:contract/ns:agent_number', namespace) is not None and customer.find('ns:contract/ns:agent_number', namespace).text else '1001',
            ...
            'person': {
                ...
                'identity_card': {
                    ...
                    'id_series': customer.find('ns:person/ns:identity_card/ns:id_series', namespace).text if customer.find('ns:person/ns:identity_card/ns:id_series', namespace) is not None and customer.find('ns:person/ns:identity_card/ns:id_series', namespace).text else '4599',
                    'id_number': customer.find('ns:person/ns:identity_card/ns:id_number', namespace).text if customer.find('ns:person/ns:identity_card/ns:id_number', namespace) is not None and customer.find('ns:person/ns:identity_card/ns:id_number', namespace).text else '999999'
                }
