     ...
     for card in root.findall('ns:card', namespace):
         card_data = {
             ...
             'cardholder': {
                 ...
                 'cardholder_number': card.find('ns:cardholder/ns:cardholder_number', namespace).text if card.find('ns:cardholder/ns:cardholder_number', namespace) is not Non 
 else None,
                 'cardholder_name': card.find('ns:cardholder/ns:cardholder_name', namespace).text if card.find('ns:cardholder/ns:cardholder_name', namespace) is not None else 
 None,
                 'person': {
                     ...
                     'surname': card.find('ns:cardholder/ns:person/ns:person_name/ns:surname', namespace).text if card.find('ns:cardholder/ns:person/ns:person_name/ns:surname 
 namespace) is not None else None,
                     'first_name': card.find('ns:cardholder/ns:person/ns:person_name/ns:first_name', namespace).text if
 card.find('ns:cardholder/ns:person/ns:person_name/ns:first_name', namespace) is not None else None,
                     'identity_card': {
                         'id_type': card.find('ns:cardholder/ns:person/ns:identity_card/ns:id_type', namespace).text if
 card.find('ns:cardholder/ns:person/ns:identity_card/ns:id_type', namespace) is not None else None,
                         'id_series': card.find('ns:cardholder/ns:person/ns:identity_card/ns:id_series', namespace).text if
 card.find('ns:cardholder/ns:person/ns:identity_card/ns:id_series', namespace) is not None else None,
                         'id_number': card.find('ns:cardholder/ns:person/ns:identity_card/ns:id_number', namespace).text if
 card.find('ns:cardholder/ns:person/ns:identity_card/ns:id_number', namespace) is not None else None
                     }
                 },
                 'address': {
                     'address_id': card.find('ns:cardholder/ns:address', namespace).get('address_id') if card.find('ns:cardholder/ns:address', namespace) is not None else Non 
                     'address_type': card.find('ns:cardholder/ns:address/ns:address_type', namespace).text if card.find('ns:cardholder/ns:address/ns:address_type', namespace) 
 is not None else None,
                     'country': card.find('ns:cardholder/ns:address/ns:country', namespace).text if card.find('ns:cardholder/ns:address/ns:country', namespace) is not None el 
 None,
                     'region': card.find('ns:cardholder/ns:address/ns:address_name/ns:region', namespace).text if
 card.find('ns:cardholder/ns:address/ns:address_name/ns:region', namespace) is not None else None,
                     'city': card.find('ns:cardholder/ns:address/ns:address_name/ns:city', namespace).text if card.find('ns:cardholder/ns:address/ns:address_name/ns:city',    
 namespace) is not None else None,
                     'street': card.find('ns:cardholder/ns:address/ns:address_name/ns:street', namespace).text if
 card.find('ns:cardholder/ns:address/ns:address_name/ns:street', namespace) is not None else None,
                     'house': card.find('ns:cardholder/ns:address/ns:house', namespace).text if card.find('ns:cardholder/ns:address/ns:house', namespace) is not None else Non 
                     'postal_code': card.find('ns:cardholder/ns:address/ns:postal_code', namespace).text if card.find('ns:cardholder/ns:address/ns:postal_code', namespace) is 
 not None else None
                 }
             },
             'card_instance': {
                 ...
                 'agent_number': card.find('ns:card_instance/ns:agent_number', namespace).text if card.find('ns:card_instance/ns:agent_number', namespace) is not None else    
 None,
                 'sequential_number': card.find('ns:card_instance/ns:sequential_number', namespace).text if card.find('ns:card_instance/ns:sequential_number', namespace) is n 
 None else None,
                 ...
                 'expiration_date': card.find('ns:card_instance/ns:expiration_date', namespace).text if card.find('ns:card_instance/ns:expiration_date', namespace) is not Non 
 else None,
                 'pin_update_flag': card.find('ns:card_instance/ns:pin_update_flag', namespace).text if card.find('ns:card_instance/ns:pin_update_flag', namespace) is not Non 
 else None,
                 ...
                 'perso_priority': card.find('ns:card_instance/ns:perso_priority', namespace).text if card.find('ns:card_instance/ns:perso_priority', namespace) is not None   
 else None,
                 'embossing_request': card.find('ns:card_instance/ns:embossing_request', namespace).text if card.find('ns:card_instance/ns:embossing_request', namespace) is n 
 None else None,
                 'pin_mailer_request': card.find('ns:card_instance/ns:pin_mailer_request', namespace).text if card.find('ns:card_instance/ns:pin_mailer_request', namespace) i 
 not None else None
             },
             'account': {
 ...
 def insert_cards(cards):
     try:
         ...
         for i, card in enumerate(cards, 1):
             ...
             INSERT INTO card_instances (instance_id, card_id, inst_id, agent_id, agent_number, sequential_number, card_status, card_state, iss_date, start_date,
 expiration_date, pin_update_flag, pin_request, perso_priority, embossing_request, pin_mailer_request)
